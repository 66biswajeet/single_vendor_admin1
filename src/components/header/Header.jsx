...
const Header = () => {
  ...
  const renderNotificationItem = (value, index) => {
    return (
      <li
        key={index + 1}
      ...
      <div className="container flex items-center justify-between h-full px-6 mx-auto text-brown-600 dark:text-brown-500">
        ...
        <ul className="flex justify-end items-center flex-shrink-0 space-x-6">
          ...
          <li className="relative inline-block text-left" ref={nRef}>
            ...
            {notificationOpen && (
              <div className="origin-top-right absolute md:right-0 -right-3 top-12 rounded-md shadow-lg bg-white dark:bg-gray-800 focus:outline-none z-50">
                <div
                  className={`${
                    data?.length === 0
                      ? "h-40"
