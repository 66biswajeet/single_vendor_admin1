  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        start_url: ".",
        id: ".",
        short_name: "InfotechIndia - E-Commerce Website",
        name: "InfotechIndia | React eCommerce Admin Dashboard",
        description:
          "InfotechIndia : React Grocery & Organic Food Store e-commerce Admin Dashboard",
        icons: [
          {
            src: "favicon.ico",
            sizes: "48x48",
